      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="row">
            ...
            <div class="col-md-3 col-sm-6 col-xs-12">
              <div class="info-box">
                <a href="<?php if($_SESSION['level']==0){echo base_url('admin/track_surat');} ?>
                         <?php if($_SESSION['level']!=0){echo base_url('admin/surat');} ?>
                         ">
               ...
               <div class="box box-primary">           
                 <div class="box-body">
                    <div class="row">
                      <div class="col-sm-12">
                        <h4>
                          Grafik Keuangan per Bulan per Tahun<?php echo date("Y"); ?>
                        </h4>
                      </div>
                      <div class="col-sm-12">
