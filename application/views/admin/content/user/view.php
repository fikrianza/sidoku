                ...
                <tbody>
                  <?php $count=1; foreach($list_user as $x){ ?>
                    <tr>
                      ...
                      <td>
                        <?php //if($x->status==1 || $x->status==true){echo "<span class='label label-success'> Aktif </span>";} ?>
                        <?php //if($x->status==0 || $x->status==false){echo "<span class='label label-warning'> Tidak Aktif </span>";} ?>
                        <!--postgres syntax-->
